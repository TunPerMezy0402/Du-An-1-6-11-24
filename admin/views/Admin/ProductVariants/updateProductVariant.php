        ...
        <div class="row">
            ...
            <div class="col-9">
                <div class="row justify-content-md-center">
                    <div class="col-7">
                        <h1>Update Sản Phẩm biến thể</h1>
                        <a href="<?= BASE_DIR ?>?act=list-productVariant" class="btn btn-primary my-3">Quay lại</a><br>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" class="form-control" id="sku" name="sku" placeholder="Mã sku" value="<?= $data['sku'] ?>">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" class="form-control" id="price" name="price"
                                    placeholder="Giá bán sản phẩm biến thể" value="<?= $data['price'] ?>">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" class="form-control" id="stock_quantity" name="stock_quantity"
                                    placeholder="Số lượng sản phẩm biến thể" value="<?= $data['stock_quantity'] ?>">
                                <span style="color: red;"><?php echo $error['stock_quantity'] ?? ''; ?></span>
                            </div>
                            <button class="btn btn-success" name="btnSendProVs" type="submit">Cập Nhật</button>
                        </form>
                    </div>
