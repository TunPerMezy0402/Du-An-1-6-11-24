        ...
        <div class="row">
            ...
            <div class="col-9">
                <div class="mb-6">
                    ...
                    <a href="<?= BASE_DIR ?>?act=list-user" class="btn btn-primary my-3">Quay lại</a>
                    <table class="table table-striped table-hover text-center">
                        ...
                        <tbody>
                            <?php foreach ($dataz as $prov => $value): ?>
                                <tr>
                                    <td><?= ucfirst($prov) ?></td>
                                    <td>
                                        <?php
                                        switch ($prov) {
                                            ...
                                            case 'role':
                                                if ($value === 'admin') {
                                                    ...
                                                    echo '<span class="text-primary">Member</span>';
                                                }
                                                break;
                                            case 'avatar':
                                                echo "<img src='" . IMG_PATH . $value . "' alt='Chưa cập nhật ảnh' />";
                                                break;
