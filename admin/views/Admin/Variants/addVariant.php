        ...
        <div class="row">
            ...
            <div class="col-9">
                <div class="row justify-content-md-center">
                    <div class="col-7">
                        <h1>Thêm mới thuộc tính biến thể</h1>
                        <a href="<?= BASE_DIR ?>?act=list-variant" class="btn btn-primary my-3">Quay lại</a>
                        <span style="color: red;"><?php echo $error['success'] ?? ''; ?></span>
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="mb-6">
                                <label for="option_name" class="form-label">Name</label>
                                <input type="text" class="form-control" id="option_name" name="option_name" placeholder="Tên thuộc tính">
                                <span style="color: red;"><?php echo $error['option_name'] ?? ''; ?></span>
                            </div>
                            <div class="mb-6">
                                <label for="option_value" class="form-label">Chi tiết thuộc tính</label>
                                <input type="text" class="form-control" id="option_value" name="option_value" placeholder="Chi tiết thuộc tính">
                                <span style="color: red;"><?php echo $error['option_value'] ?? ''; ?></span>
                            </div>
                            <button class="btn btn-success" name="btnSendVari" type="submit">Thêm mới</button>
                        </form>
                    </div>
                </div>
