                    ...
                    <div class="col-7">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" class="form-control" id="description" name="description" placeholder="Mô tả chi tiết sản phẩm">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" class="form-control" id="price" name="price" placeholder="Giá bán sản phẩm">
                                <span style="color: red;"><?php echo $error['price'] ?? ''; ?></span>
                            </div>
                            <div class="mb-6">
                                <label for="model" class="form-label">Thương hiệu</label>
                                <input type="text" class="form-control" id="model" name="model" placeholder="Thương hiệu sản phẩm">
                                <span style="color: red;"><?php echo $error['model'] ?? ''; ?></span>
                            </div>
                            <div class="mb-6">
                                <label for="brand" class="form-label">Mẫu sản phẩm</label>
                                <input type="text" class="form-control" id="brand" name="brand" placeholder="Mẫu sản xuất của sản phẩm">
                                <span style="color: red;"><?php echo $error['brand'] ?? ''; ?></span>
                            </div>
                            <div class="mb-6">
                                <label for="color" class="form-label">Màu sản phẩm</label>
                                <input type="text" class="form-control" id="color" name="color" placeholder="Màu sản phẩm">
                                <span style="color: red;"><?php echo $error['color'] ?? ''; ?></span>
                            </div>
                            <div class="mb-6">
                                <label for="material" class="form-label">Chất liệu dây</label>
                                <input type="text" class="form-control" id="material" name="material" placeholder="Chất liệu dây đeo của sản phẩm">
                                <span style="color: red;"><?php echo $error['material'] ?? ''; ?></span>
                            </div>
                            <div class="mb-6">
                                <label for="water_resistant" class="form-label">Độ chống nước</label>
                                <input type="text" class="form-control" id="water_resistant" name="water_resistant" placeholder="Độ chống nước(50ml, 100ml,...">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" class="form-control" id="stock_quantity" name="stock_quantity" placeholder="Số lượng sản phẩm">
                                <span style="color: red;"><?php echo $error['stock_quantity'] ?? ''; ?></span>
                            </div>
                            <button class="btn btn-success" name="btnSendPro" type="submit">Thêm mới</button>
                        </form>
                    </div>
                </div>
