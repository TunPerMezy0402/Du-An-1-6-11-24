        ...
        <div class="row">
            ...
            <div class="col-9">
                <div class="mb-6">
                    ...
                    <a href="<?= BASE_DIR ?>?act=add-category" class="btn btn-success">Thêm mới</a>
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= BASE_DIR ?>?act=show-category&id=<?= $cate['id'] ?>" class="btn btn-info">Show</a>
                                    <a href="<?= BASE_DIR ?>?act=update-category&id=<?= $cate['id'] ?>" class="btn btn-warning">Sửa</a>
                                    <a href="<?= BASE_DIR ?>?act=delete-category&id=<?= $cate['id'] ?>" class="btn btn-danger" 
                                    onclick="return confirm('Cảnh báo nếu bạn xóa danh mục này thì tất cả sản phẩm của danh mục này cũng bị xóa theo!')">Xóa</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
